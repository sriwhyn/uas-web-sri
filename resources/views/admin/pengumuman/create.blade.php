...
<head>
    ...
    <title>Tambah Pengumuman Baru - Webinar Event Sri</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAdmin">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">Tambah Pengumuman</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="py-5 px-4">
        <div class="container">
            <div class="card p-4 p-md-5 rounded-3 shadow-lg mx-auto" style="max-width: 600px; width: 100%;">
                ...
                <form class="mt-4" action="{{ route('admin.pengumuman.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="isi" name="isi" rows="6" required
                            ...
                            placeholder="Masukkan isi pengumuman lengkap">{{ old('isi') }}</textarea>
                        @error('isi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
