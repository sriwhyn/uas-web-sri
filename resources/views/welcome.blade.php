...
@layer base {
    *, :after, :before, ::backdrop {
    ...
    /* Hapus vertical-align karena display: block */
    img, svg, video, canvas, audio, iframe, embed, object {
        display: block; /* Tetap block karena ini sering diinginkan untuk media */
        max-width: 100%; /* Properti dari Tailwind, tetap ada */
        height: auto; /* Properti dari Tailwind, tetap ada */
    }

    /* img, video (jika perlu display: inline-block) */
    /* Jika Anda ingin img atau video bisa sejajar dengan teks dan menggunakan vertical-align,
       Anda bisa membuat aturan terpisah seperti ini (Pilihan 2 dari penjelasan sebelumnya):
    img.inline, video.inline {
        display: inline-block;
        vertical-align: middle;
    }
    Lalu di HTML Anda, gunakan <img class="inline" ...> atau <video class="inline" ...>
    */
